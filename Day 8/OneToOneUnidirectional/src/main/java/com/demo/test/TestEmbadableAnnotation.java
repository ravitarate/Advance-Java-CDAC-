...
public class TestEmbadableAnnotation {
	...
	public static void main(String[] args) {
		...
		MyUser u1=new MyUser(200,"Ajay","4444",addr);
		Address addr1=new Address(2,"Baner","pune","MH");
		MyUser u2=new MyUser(204,"Atharava","555",addr1);*/
		...
		//lazy loading
		MyUser u11=sess2.load(MyUser.class,204);
		System.out.println("display object");
		System.out.println("display object");
		System.out.println("display object");
		System.out.println("display object");
		//this will execute select statement only on MyUser33 table
